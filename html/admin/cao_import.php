<?php
/* ----------------------------------------------------------------------
   $Id: cao_import.php,v 1.2 2005/01/05 11:27:20 r23 Exp $
   ----------------------------------------------------------------------
...
if ($_POST['action']=='manufacturers_image_upload' || 
    $_POST['action']=='categories_image_upload' || 
    $_POST['action']=='products_image_upload') {
