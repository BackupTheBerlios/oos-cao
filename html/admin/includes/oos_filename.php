...
/* ----------------------------------------------------------------------
  ...
  $aFilename['affiliate'] = $prefix_filename . 'affiliate_affiliates.php';
  $aFilename['affiliate_banners'] = $prefix_filename . 'affiliate_banners.php';
  $aFilename['affiliate_banners_manager'] = $prefix_filename . 'affiliate_banners.php';
  $aFilename['affiliate_clicks'] = $prefix_filename . 'affiliate_clicks.php';
  $aFilename['affiliate_contact'] = $prefix_filename . 'affiliate_contact.php';
  $aFilename['affiliate_invoice'] = $prefix_filename . 'affiliate_invoice.php';
  $aFilename['affiliate_payment'] = $prefix_filename . 'affiliate_payment.php';
  $aFilename['affiliate_popup_image'] = $prefix_filename . 'affiliate_popup_image.php';
  $aFilename['affiliate_sales'] = $prefix_filename . 'affiliate_sales.php';
  $aFilename['affiliate_statistics'] = $prefix_filename . 'affiliate_statistics.php';
  $aFilename['affiliate_summary'] = $prefix_filename . 'affiliate_summary.php';
  $aFilename['affiliate_reset'] = $prefix_filename . 'affiliate_reset.php'; 
  ...
  $aFilename['export_preissuchmaschine'] = $prefix_filename . 'export_psm.php';
  ...
  $aFilename['keyword_show'] = 'keyword_show.php';
  $aFilename['lable'] = $prefix_filename . 'lable.php';
  ...
  $aFilename['links'] = $prefix_filename . 'links.php';
  $aFilename['links_categories'] = $prefix_filename . 'links_categories.php';
  $aFilename['links_contact'] = $prefix_filename . 'links_contact.php';
  ...
  $aFilename['rss_conf'] = $prefix_filename . 'rss.php';
